...
//Aqui o operador escopo:: estão indicando que a função/Método sacar pertence a classe Conta e que este código a seguir vai implementar a função Sacar.
bool Conta::Sacar(double Valor)
{
	//Se o valor do Saldo no Objeto for menor que o valor a ser sacado, ele não poderão sacar
	if (Saldo < Valor)
	{
...
//A função recebe como argumentos para seus seus parâmtros um Objeto do tipo Casa e um valor double.

//Aqui o parâmetro Destino irão receber este objeto
void Conta::Transferir(Conta &Destino, double Valor)
{
	...
	{
		//Aqui Destino estão com o objeto passado para a função
		//Logo vai chamar o método Depositar desta função
		Destino.Depositar(Valor);
		//Depois de depositar vocé deve retirar este valor depositado do saldo
		Saldo -= Valor;
		std::cout << "\n*****Dados*****\n";
