...
// o nome é main e ela não recebe parámetos neste exemplo (podem existir argumentos de linha de comando que serão enviados a dois parámetros da função main
